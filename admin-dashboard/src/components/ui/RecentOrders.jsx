...
const RecentOrders = () => {
    ...
    return (
       <section className="bg-white shadow-2xl my-7 mx-5 px-5 py-6 rounded-2xl border border-gray-200">
            <div className="flex justify-between items-center mb-6">
                <div className="flex justify-between flex-col gap-2">
                    <h4 className=" text-blue-600 text-lg font-thin uppercase tracking-widest">Recent Orders</h4>
